		...
		<?php if ( is_active_sidebar( 'footerwidget-1' ) ) : ?>
			...
			<div class="site-info">
				...
				<span class="footer-info-right">
					<?php echo esc_html_e(' | Design:', 'newspaperly') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'newspaperly'); ?>"><?php echo esc_html_e('Newspaperly WordPress Theme', 'newspaperly') ?></a>
				</span>
